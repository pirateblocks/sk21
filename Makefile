...
pkgdatadir = $(datadir)/skull
pkgincludedir = $(includedir)/skull
pkglibdir = $(libdir)/skull
pkglibexecdir = $(libexecdir)/skull
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/skull-config.h.in \
...
CONFIG_HEADER = $(top_builddir)/src/config/skull-config.h
...
ACLOCAL = ${SHELL} /home/kicki/sk21/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/kicki/sk21/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/kicki/sk21/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/kicki/sk21/build-aux/missing automake-1.14
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
...
MAINT = 
MAKEINFO = ${SHELL} /home/kicki/sk21/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = skull
PACKAGE_BUGREPORT = www.skull.pw
PACKAGE_NAME = Skull Core
PACKAGE_STRING = Skull Core 1.0.0
PACKAGE_TARNAME = skull
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/kicki/sk21
abs_srcdir = /home/kicki/sk21
abs_top_builddir = /home/kicki/sk21
abs_top_srcdir = /home/kicki/sk21
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/kicki/sk21/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/vsyncd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/vsync-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/vsync-cli$(EXEEXT)
...
src/config/skull-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/skull-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/skull-config.h
$(top_srcdir)/src/config/skull-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/skull-config.h src/config/stamp-h1
