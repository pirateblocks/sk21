...
{
public:
    /// Is the inputs associated with this public key? (and there is 250000 Sk21 - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of skull.
