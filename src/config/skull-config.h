/* src/config/skull-config.h.  Generated from skull-config.h.in by configure.  */
/* src/config/skull-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.skull.pw"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Skull Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Skull Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "skull"
