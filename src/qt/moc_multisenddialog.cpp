...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MultiSendDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 84, 25),
QT_MOC_LITERAL(6, 110, 24),
QT_MOC_LITERAL(7, 135, 28)
    },
...
const QMetaObject MultiSendDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MultiSendDialog.data,
      qt_meta_data_MultiSendDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MultiSendDialog.stringdata))
