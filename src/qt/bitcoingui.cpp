                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Skull Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Skull address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skull: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Skull Core"), this);
    aboutAction->setStatusTip(tr("Show information about Skull Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Skull"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Skull addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Skull addresses"));
    ...
    openAction->setStatusTip(tr("Open a Skull: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Skull Core help message to get a list with possible Skull command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Skull Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Skull network", "", count));
}
...
{
    QString strTitle = tr("Skull Core"); // default title
