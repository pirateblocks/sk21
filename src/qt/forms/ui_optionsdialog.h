...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeVsync = new QSpinBox(tabMain);
        anonymizeVsync->setObjectName(QStringLiteral("anonymizeVsync"));
        anonymizeVsync->setMinimum(100);
        anonymizeVsync->setMaximum(100000);
        anonymizeVsync->setSingleStep(100);
        anonymizeVsync->setValue(1000);

        horizontalLayout->addWidget(anonymizeVsync);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Skull after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Skull on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Skull to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Skull client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Skull network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Skull.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/skull-project/skull-project-translations", 0));
