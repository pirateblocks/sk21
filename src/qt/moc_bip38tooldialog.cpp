...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Bip38ToolDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 50, 26),
QT_MOC_LITERAL(4, 77, 31),
QT_MOC_LITERAL(5, 109, 28),
QT_MOC_LITERAL(6, 138, 26),
QT_MOC_LITERAL(7, 165, 31),
QT_MOC_LITERAL(8, 197, 34),
QT_MOC_LITERAL(9, 232, 26)
    },
...
const QMetaObject Bip38ToolDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Bip38ToolDialog.data,
      qt_meta_data_Bip38ToolDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Bip38ToolDialog.stringdata))
