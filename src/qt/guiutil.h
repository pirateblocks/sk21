...
/** Utility functions used by the Skull Qt UI.
 */
namespace GUIUtil
{
...
// Render Skull addresses in monospace font
...
// Parse "skull:" URI into recipient object, return true on successful parsing
