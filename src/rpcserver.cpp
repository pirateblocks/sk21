...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Skull features */
        {"skull", "masternode", &masternode, true, true, false},
        {"skull", "masternodelist", &masternodelist, true, true, false},
        {"skull", "mnbudget", &mnbudget, true, true, false},
        {"skull", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"skull", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"skull", "mnsync", &mnsync, true, true, false},
        {"skull", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"skull", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use skulld, or the -server option to skull-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> skull-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:72013/\n";
}
