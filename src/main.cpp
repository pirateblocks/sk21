...
#if defined(NDEBUG)
#error "Skull cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight < 100000 && nHeight > 0) {
        nSubsidy = 100 * COIN;
    } else if (nHeight < 100000 && nHeight >= 86400) {
        nSubsidy = 100 * COIN;
    } else if (nHeight <= Params().LAST_POW_BLOCK() && nHeight >= 100000) {
        nSubsidy = 80 * COIN;
