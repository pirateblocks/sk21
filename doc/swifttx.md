...
This mechanism has been integrated into Bitcore-Node-Sk21 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Sk21-Project/insight-api-skull#web-socket-api](https://github.com/Sk21-Project/insight-api-skull#web-socket-api) 
* API: [https://github.com/Sk21-Project/insight-api-skull#swifttx-transactions](https://github.com/Sk21-Project/insight-api-skull#swifttx-transactions) 
...
By default, the Sk21 Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sk21 Core daemon:
