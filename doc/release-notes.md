Skull Core version 2.2.1 is now available from:

  <https://github.com/skull-project/skull/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/skull-project/skull/issues>

Compatibility
==============

Skull Core is extensively tested on multiple operating systems using
...
Skull Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Skull was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/skull-project-translations/).
