...
In order to support loading of multiple wallets in skull-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skull.cpp.
...
Changes to skull.cpp
----------------------
skull.cpp is the entry point into skull-qt, and as such, will require some minor modifications to provide hooks for
