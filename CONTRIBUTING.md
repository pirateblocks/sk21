Contributing to Skull Core
============================

The Skull Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Skull Core project, and is not to be
confused with overall Skull Network Protocol consensus changes.

Whether a pull request is merged into Skull Core rests with the project merge
...
Patches that change Skull consensus rules are considerably more involved than
...
Where a patch set proposes to change the Skull consensus, it must have been
...
The project leader is the release manager for each Skull Core release.
